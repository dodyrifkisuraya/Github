...
class MainViewModel @Inject constructor(
    ...
    private val _resultSearchUser = MutableLiveData<ResultState<List<User>>>()
    val resultSearchUser: LiveData<ResultState<List<User>>> get() = _resultSearchUser
    ...
    fun searchUser(key: String){
        val disposable = githubUseCase.searchUser(key)
            .subscribe{res ->
                _resultSearchUser.value = res
            }
